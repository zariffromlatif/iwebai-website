...
const footerLinks = {
  ...
  community: [
    { label: 'Reddit', href: 'https://www.reddit.com/r/IWEBai/', external: true },
    { label: 'Support', href: 'mailto:support@fixpoint.dev', external: true },
  ],
}
