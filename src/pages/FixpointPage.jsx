...
const features = [
  ...
  },
  {
    icon: GitBranch,
    title: 'CI/CD Native',
    description: 'GitHub Action, GitHub App, self-hosted webhook server, or CLI. Integrates into your GitHub workflow.',
  },
  {
    icon: Lock,
    title: 'Auto-Fix PRs',
    ...
    >
      ...
      <section className="relative py-32 px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          >
            Fixpoint is the immune system of your codebase. Deterministic AST
            transformations fix security vulnerabilities in Python and
            JavaScript/TypeScript before they ever reach production.
          </motion.p>
