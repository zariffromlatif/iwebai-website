      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            applies deterministic, rule-based patches to your Python and
            JavaScript/TypeScript code—eliminating security debt before it ever
            hits your main branch.
          </motion.p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: "SQL injection, hardcoded secrets, XSS, command injection, path traversal, SSRF (Python); eval, secrets, DOM XSS (JavaScript/TypeScript).",
                },
                {
                ...
                {
                  title: "Safety First",
                  desc: "Built-in idempotency and loop prevention. Status check fixpoint/compliance: PASS when all violations are fixed, FAIL when they remain.",
                },
              ].map((item, i) => (
                <div
                  key={i}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-zinc-400 mb-6 sm:mb-8">
              Use the GitHub Action, install the GitHub App, run a self-hosted
              webhook server, or use the CLI—Fixpoint fits your infrastructure.
            </p>
            <div className="rounded-2xl border border-white/[0.05] bg-white/[0.02] overflow-hidden">
              <div className="flex items-center gap-2 px-4 py-3 border-b border-white/[0.05] bg-white/[0.02]">
  ...
  env:
    GITHUB_TOKEN: \${{ secrets.GITHUB_TOKEN }}`}
            ...
            <p className="text-sm text-zinc-500 mt-4">
              ...
              >
                github.com/apps/fixpoint-security/installations/new
              </a>
            </p>
      ...
      <section className="py-16 sm:py-20 md:py-24 px-6 lg:px-8 border-t border-white/[0.03]">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-zinc-400 mb-12 max-w-2xl mx-auto px-4">
            Join the developers using Fixpoint to secure their Python and
